...
<div align="right">
    <i> Таблица 1. Оценка применимости алгоритмов для потоковых аудио контейнеров [3]. </i>
</div>
...
Основное применение функции Альтера-Джонсона – определение значений, наиболее близких к периодам, в данных, имеющих нелинейные колебания [4]. 
